...
use bitcoin::{ecdsa, hashes, io, key, secp256k1, taproot, Transaction};
...
bitcoin_internals::impl_from_infallible!(Error);
...
impl From<bitcoin::io::Error> for Error {
    fn from(e: bitcoin::io::Error) -> Self { Error::Io(e) }
}
